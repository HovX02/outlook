...
def satisfy_proofs_with_pool(
    ...
    *,
    ...
    """
    from service.account import graph_mail
    from service.resource.recovery.proof_pool import iter_accounts
...
def satisfy_proofs_with_external(
    ...
    *,
    ...
    """
    from service.resource.recovery import external_recovery_pool as ext_pool
...
def _satisfy_proofs_imap(
    ...
    *,
    ...
    from service.resource.recovery import external_recovery_pool as ext_pool
    from service.account.mail_reader import read_security_code_imap_password
...
def _satisfy_proofs_cf_domain(
    ...
    *,
    ...
    from service.resource.recovery import cf_domain_mail
...
def follow_auto_post_forms(
    ...
    *,
    ...
    必须手动解析表单字段并逐跳 POST。
    """
    from service.resource.recovery.proof_pool import pool_enabled
