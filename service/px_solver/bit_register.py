...
from service.px_solver.bit_px_solver import ensure_profile_for, _open, _close, clear_profile_data

# CDP 真按 + 可见 captcha 检测（懒加载，避免 import ss_register 拖慢启动）
from service.px_solver.px_swiftshader_solver import _visible_captcha_box
